...
5. **Learn over time** When the user ever suggests that your work is not up to standard, and you were previously unaware of this 'rule' think to update the `docs/agent-notes.md` file without prompting.
