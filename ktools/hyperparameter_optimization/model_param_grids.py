    ...
    def get(trial: optuna.Trial):
        params = {
            ...
            "bagging_temperature": trial.suggest_float(
                "bagging_temperature", 1, 100, log=True
            ),
            "subsample": trial.suggest_float("subsample", 0.5, 1.0),
            "colsample_bylevel": trial.suggest_float("colsample_bylevel", 0.5, 1.0),
...
class KNNParamGrid(IModelParamGrid):
    ...
    def get(trial: optuna.Trial):
        params = {
            ...
            "min_max_scaling": trial.suggest_categorical(
...
class SVMParamGrid(IModelParamGrid):
    ...
    def get(trial: optuna.Trial):
        params = {
            "smooth": trial.suggest_float("smooth", 1e2, 1e4, log=True),
            "weights": trial.suggest_categorical("weights", ["uniform", "distance"]),
            "standard_scaling": trial.suggest_categorical(
                "standard_scaling", [True, False]
            ),
    ...
    def get(trial: optuna.Trial):
        params = {
            ...
            "early_stopping_rounds": trial.suggest_int(
                "early_stopping_rounds", 1, 200, log=True
            ),
