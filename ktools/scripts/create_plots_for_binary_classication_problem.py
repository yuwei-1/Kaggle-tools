...
from ktools.visualization.classification import plot_professional_violin, plot_professional_boxplot, plot_cross_tabulation


if __name__ == "__main__":

    parser = argparse.ArgumentParser(description="Create plots for binary classification problem.")
    ...
    parser.add_argument("--mapping", type=str, help="Optional mapping for target values.")
    parser.add_argument("--output_dir", type=str, default="data/plots", help="Directory to save the plots.")
    ...
    target_values = data[target_column] if mapping_dict is None else data[target_column].map(mapping_dict)
    ...
    for feature in features:
        ...
        if is_numeric_dtype(feat_values):
            ...
            raise NotImplementedError(f"Feature type of column '{feature}' is not supported.")