...
class TestWalkForwardSplits(unittest.TestCase):
    ...
    def test_split(self):
        ...
        split_obj = WalkForwardSplit(
            minimum_training_points=100_000,
            testing_points=100_000,
            n_splits=3
        )
        ...
        for train_idx, test_idx in split_obj.split(data):
            ...
            i += 1
        plt.savefig("./ktools/model_selection/tests/test_data/plots/test_walk_forward_split.png")
        plt.close()
        ...
        # Assert
        expected_split_idcs = np.load("./ktools/model_selection/tests/test_data/expected_split_idcs.npy")
