...
class TestVariationalGPModel(unittest.TestCase):
    ...
    def test_fit_variation_gp(self):
        ...
        X, y = make_regression(n_samples=100_000, n_features=10, noise=0.1, random_state=42)
        ...
        self.assertAlmostEqual(expected_rmse, root_mean_squared_error(y, y_pred), places=6)