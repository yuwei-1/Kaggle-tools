...
def create_oofs_from_model(
    ...
    score_tuple, oof_predictions, model_list = cross_validation_executor.run(
        X_train,
        y_train,
        additional_data=additional_data,
        output_transform_list=output_transform_list,
    )
    ...
    model_string = (
        str(cross_validation_executor.model) if model_string is None else model_string
    )
